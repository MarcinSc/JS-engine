...
public enum Operator {
	MEMBER_ACCESS(1, 1, true, true, false, true), MAPPED_ACCESS(1, 1, true, false, true, true, "]"), FUNCTION_CALL(1, 1, true, false, true, false, ")"),
	...
	private Operator(int consumeLength, int priority, boolean leftAssociative, boolean binary, boolean hasParameters) {
		this(consumeLength, priority, leftAssociative, binary, hasParameters, false, null);
	}
	...
	private Operator(int consumeLength, int priority, boolean leftAssociative, boolean binary, boolean hasParameters, boolean exactlyOneParameter, String parametersClosing) {
		_consumeLength = consumeLength;
		_priority = priority;
		_leftAssociative = leftAssociative;
		_binary = binary;
		_hasParameters = hasParameters;
		_exactlyOneParameter = exactlyOneParameter;
