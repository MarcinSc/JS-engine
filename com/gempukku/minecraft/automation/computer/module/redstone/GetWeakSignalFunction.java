...
public class GetWeakSignalFunction implements ModuleFunctionExecutable {
    @Override
    ...
    public Object executeFunction(int line, World world, ModuleComputerCallback computer, Map<String, Variable> parameters) throws ExecutionException {
        ...
        int side = StorageModuleUtils.getComputerFacingSide(line, computer, sideParam, "getWeakSignal");

        ChunkPosition position = computer.getChunkPosition();
        return world.getIndirectPowerLevelTo(
